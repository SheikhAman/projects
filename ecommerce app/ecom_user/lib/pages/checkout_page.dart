...
import 'package:ecom_user/pages/product_page.dart';
...
class _CheckoutPageState extends State<CheckoutPage> {
                ...
                Card(
                  ...
                  child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Center(
                        child: const Text('Fetching address...'),
                      );
                    },
                  ),
                ),
  ...
  void _saveOrder() {
    ...
    orderProvider.addOrder(orderM, cartProvider.cartList).then((_) {
      orderProvider.updateProductStock(cartProvider.cartList).then((_) {
        orderProvider
